...
def process_salary_info(content_element: Tag, salary_details: Dict[str, Any]) -> None:
    """
    Process salary information from content element
    
    Args:
        content_element: Content Tag object
        salary_details: Salary details dictionary to update
    """
    # Check for salary list items
    ...
    if salary_list_items:
        ...
        for item in salary_list_items:
            ...
            # Check for keyword patterns in salary items
...
def process_general_salary(details: Dict[str, Any]) -> None:
    """
    Process salary text for numerical values
    
    Args:
        details: Job details dictionary to update
    """
    # Parse the general salary text for numerical values
    ...
    # Try to extract minimum and maximum salary amounts
